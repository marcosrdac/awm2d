...
function Δt∇²(A::AbstractArray, Δtoh²::Real, z::Integer, x::Integer)
    global h²∇²  # constant 3x3 matrix
    global ∇²r   # its radius (1)
    window = @view A[z-∇²r:z+∇²r, x-∇²r:x+∇²r]
    Δt∇² = Δtoh² * reduce_pointwise_product(h²∇², window)
end
...
function propagate(P::Array{Float64,3},
                   v::Array{Float64,2},
